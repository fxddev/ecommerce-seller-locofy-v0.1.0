...
const BasicDialogModalConfirmLogou = ({ onClose }) => {
  return (
    <View style={[styles.basicDialogModalconfirmlogou, styles.actionsFlexBox]}>
      <View style={[styles.titleDescription, styles.buttonFlexBox]}>
        ...
        />
        <Text style={[styles.headline, styles.mt16]}>Logout Sekarang?</Text>
      ...
      <View style={[styles.actions, styles.actionsFlexBox]}>
        <View style={[styles.actions1, styles.actions1FlexBox]}>
          ...
          <View style={[styles.button, styles.ml8, styles.buttonFlexBox]}>
            <View style={[styles.stateLayer, styles.actions1FlexBox]}>
              <Text style={[styles.labelText, styles.textTypo]}>Ya</Text>
            </View>
          </View>
        </View>
      </View>
...
export default BasicDialogModalConfirmLogou;
